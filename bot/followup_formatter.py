...
LABELS = {
    ...
    "unit_evol": "销量 Evol%", "atv_actual": "客单价", "spend_actual": "BET花费 Actual",
    "spend_evol": "BET花费 Evol%", "spend_weight": "BET花费 Wgt%", "spend_weight_change": "BET花费 Wgt Change",
...
def format_followup_result(plan: dict, result: dict) -> dict:
    ...
    parts.extend("> **Remark**：" + note for note in result.get("remarks", []) if note)
